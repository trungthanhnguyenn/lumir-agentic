...
tbi_definitions = {
    ...
    "bci": "Behavioral Challenge Index - phản ánh khó khăn trong việc duy trì kỷ luật và hành vi đúng khi thị trường thay đổi → nhận diện “nút thắt” để thiết kế thử thách và coaching tương ứng."
}
